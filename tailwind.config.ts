	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'cosmic-glow': {
					'0%, 100%': { boxShadow: '0 0 20px hsl(270 80% 50% / 0.3)' },
					'50%': { boxShadow: '0 0 40px hsl(270 80% 50% / 0.6)' }
				},
				'float': {
				...
				'pulse-accent': {
					'0%, 100%': { boxShadow: '0 0 30px hsl(180 100% 50% / 0.3)' },
					'50%': { boxShadow: '0 0 50px hsl(180 100% 50% / 0.6)' }
				},
				'fade-in': {
